...
except ImportError: # as in src/project.py, made necessary by the way cluster submission is handled by the scheduler
...
fn_group_smarts = { # mapped SMARTS (SMIRKS) for common functional groups
    'phthalimide'     : '[*:1]-[#6:2](=[#8:3])-[#7:4](-[*:5])-[#6:6](=[#8:7])-[*:8]',
    'carbamate'       : '[*:1]-[#7:2](-[#6:3](=[#8:4])-[#8:5]-[*:6])-[#1:7]',
    'cyclocarbonate'  : '[*:1]-[#6:2]1(-[#1:8])-[#8:3]-[#6:4](=[#8:5])-[#8:6]-[#6:7]-1(-[*:9])-[#1:10]',
    'anhydride'       : '[*:1]-[#6:2](=[#8:3])-[#8:4]-[#6:5](=[#8:6])-[*:7]',
    'vinyl'           : '[*:1]-[#6:2](=[#6:3](-[#1:5])-[#1:6])-[#1:4]',
    'terminal_alkene' : '[*:1]-[#6:2](-[*:3])=[#6:4](-[#1:5])-[#1:6]',
    'acyl_chloride'   : '[#17:1]-[#6:2](=[#8:3])-[*:4]',
    'carboxyl'        : '[#8:1](-[#6:2](=[#8:3])-[*:4])-[#1:5]',
    'ester'           : '[*:1]-[#8:2]-[#6:3](=[#8:4])-[*:5]',
    'amine'           : '[#7:1](-[*:2])(-[#1:3])-[#1:4]',
    'hydroxyl'        : '[#1:1]-[#8:2]-[!$([#6]=[#8]):3]',
