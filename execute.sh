...
python src/project.py -path $projdir submit --parallel --bundle 10 -o everything --partition amilan --account ucb576_asc1 --job-output polyid_build.out # Alpine allocation
